...
const BUILD_SHA = true ? "2876762" : "dev";
const BUILD_TIME = true ? "2026-05-11T23:46:08Z" : "";
...
function TopBar({ subtitle, layout, setLayout, narrow = false }) {
  return /* @__PURE__ */ React.createElement("div", { style: {
  ...
  } }, /* @__PURE__ */ React.createElement(IcLock, { size: 12, color: theme.accent })), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 14, fontWeight: 700, letterSpacing: "0.32em", color: theme.ink } }, "OBSCURA"), !narrow && /* @__PURE__ */ React.createElement(
    "a",
    {
    ...
    " \xB7 build ",
    BUILD_SHA
  )), !narrow && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { width: 1, height: 18, background: theme.border, margin: "0 4px" } }), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: theme.inkDim, whiteSpace: "nowrap" } }, /* @__PURE__ */ React.createElement("a", { href: "/transparency.html", style: { color: theme.inkDim, textDecoration: "none" } }, "transparency"), " \xB7 ", /* @__PURE__ */ React.createElement("a", { href: "/status.html", style: { color: theme.inkDim, textDecoration: "none" } }, "status"), " \xB7 ", /* @__PURE__ */ React.createElement("a", { href: "/privacy.html", style: { color: theme.inkDim, textDecoration: "none" } }, "privacy"), " \xB7 ", /* @__PURE__ */ React.createElement("a", { href: "/support.html", style: { color: theme.inkDim, textDecoration: "none" } }, "support")))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: narrow ? 8 : 14, fontSize: 11, color: theme.inkDim } }, subtitle && !narrow && /* @__PURE__ */ React.createElement("span", { style: { color: theme.inkFaint } }, subtitle), !narrow && /* @__PURE__ */ React.createElement(Clock, { color: theme.ink }), !narrow && /* @__PURE__ */ React.createElement(Tag, { secure: true }, /* @__PURE__ */ React.createElement(Dot, { color: theme.secure, pulse: true }), " secure"), /* @__PURE__ */ React.createElement(Tag, { accent: true }, "ZK \xB7 OK"), !narrow && /* @__PURE__ */ React.createElement(LayoutToggle, { layout, setLayout })));
}
...
function CommandStrip({ screen }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: {
    ...
    borderRadius: 4,
    border: `1px solid ${theme.border}`
  } }, /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("span", { style: { color: theme.accent } }, "\u203A"), " ", cmd), /* @__PURE__ */ React.createElement("span", { style: { color: theme.inkFaint } }, screen.toUpperCase(), " \xB7 0x", Math.floor(Math.random() * 65535).toString(16).toUpperCase().padStart(4, "0")));
}
...
function App() {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: {
    ...
    gap: 18,
    minHeight: 0
  } }, /* @__PURE__ */ React.createElement(LeftRail, { screen, active, stats: cryptoStats, events: auditEvents, passEnabled }), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 14, minWidth: 0 } }, hero, /* @__PURE__ */ React.createElement(SpecStrip, { active, stats: cryptoStats, ttl, maxDL }), /* @__PURE__ */ React.createElement(CommandStrip, { screen })), /* @__PURE__ */ React.createElement(RightRail, { files, active, stats: cryptoStats })), effectiveLayout === "centered" && /* @__PURE__ */ React.createElement("div", { style: {
    flex: 1,
    ...
    flexDirection: "column",
    gap: narrow ? 12 : 18
  } }, hero, /* @__PURE__ */ React.createElement(PayloadInline, { files }), /* @__PURE__ */ React.createElement(SpecStrip, { active, narrow, stats: cryptoStats, ttl, maxDL }), /* @__PURE__ */ React.createElement(CommandStrip, { screen }))), effectiveLayout === "terminal" && /* @__PURE__ */ React.createElement("div", { style: {
    flex: 1,
    ...
    color: theme.inkDim,
    letterSpacing: "0.18em"
  } }, "obscura ~ encrypt"), /* @__PURE__ */ React.createElement("span", { style: { width: 60 } })), /* @__PURE__ */ React.createElement("div", { style: { padding: narrow ? 14 : 22, display: "flex", flexDirection: "column", gap: 14 } }, hero, /* @__PURE__ */ React.createElement(PayloadInline, { files }), /* @__PURE__ */ React.createElement(CommandStrip, { screen }))))));
}
